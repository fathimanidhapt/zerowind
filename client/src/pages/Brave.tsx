...
export default function Brave() {
  const tech = services.find((t) => t.id === "brave") || services[3];
  const relatedProducts = products.filter((p) => p.technologyId === "brave");
  ...
  const scrollToContent = () => {
    const nextSection = document.getElementById("brave-details");
    if (nextSection) {
  ...
  return (
    <div className="bg-neutral-950 text-white min-h-screen relative overflow-hidden select-none">
      ...
      <div id="brave-details" className="max-w-7xl mx-auto px-6 md:px-12 py-24 relative z-10">
        ...
        <div className="pl-0 md:pl-48 mb-28 w-full">
          <div className="max-w-4xl space-y-6">
            ...
            >
              High wind protection combined with maximum lightness thanks to the innovative single-layer fabric construction. Ultralight fabrics perfect for making garments with excellent technical characteristics, durable and extremely easy to carry.
            </motion.p>
          </div>
        </div>
      ...
      <section className="relative w-full px-4 md:px-8 pt-10 md:pt-14 pb-24 flex justify-center bg-transparent">
        ...
        >
          <img
            src="/images/imgi_18_vaporapreview%401320x1020_r.jpeg.webp"
            alt="Discover Vapora"
