...
export default function Vapora() {
  const tech = services.find((t) => t.id === "vapora") || services[4];
  const relatedProducts = products.filter((p) => p.technologyId === "vapora");
  ...
  const scrollToContent = () => {
    const nextSection = document.getElementById("vapora-details");
    if (nextSection) {
      ...
      <AnimatePresence>
        {showSideWatermark && (
          <motion.div
            ...
            className="fixed left-[-180px] sm:left-[-160px] md:left-[-135px] top-[50vh] z-0 select-none pointer-events-none transform origin-center -rotate-90"
          >
            <img
              src="/images/download (6).svg"
              alt="VAPORA Watermark"
      ...
      <div id="vapora-details" className="max-w-7xl mx-auto px-6 md:px-12 py-24 relative z-10">
        ...
        <div className="pl-0 md:pl-48 mb-28 w-full">
          <div className="max-w-4xl space-y-6">
            ...
            >
              Its structure combines extreme lightness and advanced thermoregulation, offering constant insulation even in the most variable conditions.
            </motion.p>
            <motion.p
              initial={{ opacity: 0, y: 30 }}
              whileInView={{ opacity: 1, y: 0 }}
              ...
              className="text-white text-lg md:text-xl lg:text-2xl leading-relaxed font-body font-light"
            >
              Thanks to optimal moisture management, Vapora reduces sweat and maintains a dry and comfortable internal microclimate, making physical activity extremely enjoyable.
            </motion.p>
            <motion.p
              initial={{ opacity: 0, y: 30 }}
              whileInView={{ opacity: 1, y: 0 }}
              ...
              className="text-white text-lg md:text-xl lg:text-2xl leading-relaxed font-body font-light"
            >
              With Vapora, every layer becomes an invisible ally: dynamic, technical, essential.  The perfect balance between protection, comfort, and performance.
            </motion.p>
          </div>
        </div>
